...
Al intentar validar un XML donde dos servidores comparten el mismo `id` (por ejemplo, duplicar `srv-web-01`), VS Code (o cualquier validador XSD) muestra un error similar a:
